...
import { findAllOrders, countOrders } from '../../dao';

const getAllOrders = async (query: OrderQueryParams = {}): Promise<OrderResponse> => {
  ...
  const total = await countOrders(queryWithDates);
