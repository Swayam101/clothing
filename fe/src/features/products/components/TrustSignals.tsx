  ...
  return (
    <div className="border-t border-gray-200 pt-8 space-y-4">
      <div className="flex items-start space-x-3">
        <Sparkles className="text-gray-600 flex-shrink-0 mt-1" size={18} strokeWidth={1.5} />
        <div>
          <p className="text-sm font-medium">Handpicked & Quality-Checked</p>
          <p className="text-xs text-gray-500">Every pre-loved piece is carefully curated</p>
        </div>
      </div>
      <div className="flex items-start space-x-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Sustainable fashion delivered to your doorstep</p>
        </div>
      </div>
      <div className="flex items-start space-x-3">
